...
class JukeboxPlayer:
    def __init__(self, update_now_playing_callback, update_up_next_callback, update_upcoming_songs_callback, start_playback_callback=None):
    ...
    def play_song_immediately(self, song):
        ...
        try:
            ...
            with self.immediate_lock:
                self.immediate_playback = False
        Clock.schedule_once(lambda dt: self.update_up_next())
    ...
    def play_songs(self):
        while True:
            try:
                ...
                print(f"Error in play_songs loop: {e}")
    ...
    def _play_next_song(self, song):
        ...
        try:
            ...
            for playlist in [self.default_playlist, self.Special_playlist, self.primary_playlist]:
                if song in playlist:
                    try:
